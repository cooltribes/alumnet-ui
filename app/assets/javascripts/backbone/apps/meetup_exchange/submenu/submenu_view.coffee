@AlumNet.module 'MeetupExchangeApp.Submenu', (Submenu, @AlumNet, Backbone, Marionette, $, _) ->
  class Submenu.Menu extends Marionette.ItemView
    template: 'meetup_exchange/submenu/templates/submenu'
  ...
  AlumNet.commands.setHandler 'render:meetup_exchange:submenu',(view,tab) ->
