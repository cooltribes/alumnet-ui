@AlumNet.module 'EventsApp.Payment', (Payment, @AlumNet, Backbone, Marionette, $, _) ->
  ...
  class Payment.PaymentView extends Marionette.ItemView
    ...
    reloadWidget: (e)->
      ...
      country.fetch
        success: (model) ->
          parameters_string = 'country_code='+model.get('cc_fips')+'key=1acce8f2587d6f7cca456c87cc672bd2sign_version=2success_url=http://alumnet-test.aiesec-alumni.orguid='+view.current_user.get("id")+'widget=p1_1ea9c9cad7ce7d4c6ad745b48f36a9d45'
