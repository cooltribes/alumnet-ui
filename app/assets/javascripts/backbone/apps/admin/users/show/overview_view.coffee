  ...
  class UserShow.Layout extends Marionette.LayoutView
    ...
    activateClicked: (e)->
      ...
      Backbone.ajax
        ...
        success: (data) =>
          @model.set(data)
          view.ui.activateUser.removeClass('btn-primary js-activate-user').addClass('btn-danger js-ban-user').html('<i class="icon-entypo-cancel"></i>Ban user')
        error: (response) =>
    ...
    banClicked: (e)->
      ...
      Backbone.ajax
        ...
        success: (data) =>
          @model.set(data)
          view.ui.activateUser.removeClass('btn-danger js-ban-user').addClass('btn-primary js-activate-user').html('<i class="icon-entypo-check"></i>Activate user')
        error: (response) =>
          message = AlumNet.formatErrorsFromApi(response.responseJSON)
          $.growl.error(message: message)
