@AlumNet.module 'AdminApp.BanerList', (BanerList, @AlumNet, Backbone, Marionette, $, _) ->
  ...
  class BanerList.Layout extends Marionette.LayoutView
    template: 'admin/baner/list/templates/layout'
    className: 'container'
    regions:
      table: '#list-region'
  ...
  class BanerList.CreateView extends Marionette.ItemView
    template: 'admin/baner/list/templates/createBaner'
  ...
  class BanerList.BanerView extends Marionette.ItemView
    template: 'admin/baner/list/templates/baner'

  #Vista la lista de baners
  class BanerList.BanerTable extends Marionette.CompositeView
    template: 'admin/baner/list/templates/baner_table'
