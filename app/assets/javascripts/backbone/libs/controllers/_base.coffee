@AlumNet.module 'Controllers', (Controllers, @AlumNet, Backbone, Marionette, $, _) ->
  ...
  class Controllers.Base extends Marionette.Controller
    ...
    label_for: (resource)     ->
      if @__labels(resource)
        @__labels(resource)
      else
        resource

    __labels: (resource)->
      App.labels ||= App.request('labels:entities')
      App.labels.getContent(resource)
